...
from lib.color import FigureColor
...
class Rectangle(Figure):
    ...
    def __init__(self, color_param, width_param, height_param):
        """
        Класс содержит конструктор по параметрам «ширина», «высота» и «цвет». В конструкторе создается объект класса «Цвет фигуры» для хранения цвета.
        """
    ...
    def square(self):
        """
        Класс переопределяет метод, вычисляющий площадь фигуры.
        """
